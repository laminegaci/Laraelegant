        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                @can('access_users')
                    ...
                    @else
                    <li> <a class="waves-effect waves-dark prevent_link" href="{{ route('users.index') }}" aria-expanded="false"><i class="fa fa-user-circle-o"></i><span class="hide-menu">Users</span></a></li>
                @endcan
                @can('access_roles')
